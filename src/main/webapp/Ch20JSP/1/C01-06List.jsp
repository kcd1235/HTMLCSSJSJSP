<!-- 
	post.jsp로 이동하기위한 자바스크립트함수 post() 추가
	read.jsp로 이동하기위한 자바스크립트함수 read(num) 추가
 -->
...
function list(){
	document.listFrm.action="C01-04List.jsp";
...
<tr>
	...
	<table width=1000>
		...
		<tr>
			...
			<td align=center><a href="javascript:read('<%=bean.getNum()%>'"><%=bean.getSubject() %></a></td>
...
<!-- 검색 -->
<form name=searchFrm method=get action=C01-05List.jsp>
<table width=1000 >
	<tr>
		<td align=center>
