...
<tr>
	<td class="c1">일반전화</td>
	<td>
	<input type="tel" name=tel1 size=5px> 
	- 
	<input type="tel" name=tel2 size=5px> 
	- 
	<input type="tel" name=tel3 size=5px></td>
</tr>
<tr>
	<td class="c1">이메일</td>
...
<tr>
	<td class="c1">우편번호*</td>
	<td><input type="text" name=addrnum required >&nbsp;<a href="#"><input type=button value=주소찾기></a></td>
</tr>
<tr>
	<td class="c1">기본주소*</td>
...
<tr>
	<td class="c1">수신동의</td>
	<td><input type="checkbox" name="smsrecv">SMS 수신 <input type="checkbox" name="emailrecv">EMAIL 수신</td>
</tr>
</tbody>
